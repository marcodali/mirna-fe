...
export const GET_CODE_API = 'http://localhost:4000/sockets/1?username=__USERNAME__&project=__PROJECT__'
export const WSS_PROJECT_URI = 'ws://localhost:4000/__USERNAME__/__PROJECT__' */

// general
const sampleFiles = ['/broadcastServerSample.txt', '/echoServerSample.txt', '/librariesUsage.txt']
export const CODE_SAMPLE = sampleFiles[Math.floor(Math.random() * sampleFiles.length)]
...
export const SERVER_PROJECT_EXAMPLE = 'https://gist.github.com/marcodali/f71c88953f648d9c90fe25fd254f88c4'
